...
export async function getOrderSummary() {
  ...
  const totalSales = await prisma.order.aggregate({
    // _sum operator tells Prisma to calculate the sum of all totalPrice values in the order table.
  ...
  // Result : [ { month: '03/25', totalSales: 1582 } ]

  // Convert salesDataRaw to JavaScript-Friendly Format
